...
#pragma acc data copy(x[0:Ntime*Nbodies],y[0:Ntime*Nbodies],z[0:Ntime*Nbodies]) create(ax[0:Nbodies],ay[0:Nbodies],az[0:Nbodies],vx,vy,itimep1,itime,itimem1)
   {
