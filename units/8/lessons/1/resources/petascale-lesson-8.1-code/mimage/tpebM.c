...
//
//   tpebM makes the pebble images from the MPI lesson....
//
...
//                      ../Vis-Movie/data/pebble.mvlp
  ...
  fnameptr  =   fopen ("../MPI-Waves/data/pebble.filenames","r");

  fhdrptr  =   fopen ("../MPI-Waves/data/pebble.hdr","r");
...
// add the directory to head of data file name
  for (int icm=0;icm<26;icm++)
    {
       dirfilename[icm+17] = filename[icm];
    }
