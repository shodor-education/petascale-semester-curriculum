        program main_pebble_mpimp
! Blue Waters Petascale Semester Curriculum v1.0
! File: MPI-OpenMP-Pebble/openmpimp/pebble_mpimp.f
...
!
!       uses MPI calls
!       uses OpenMP calls for major loops
!
...
!
!       compiler needs   -fopenmp flag set
!
        USE OMP_LIB
        include  'mpif.h'
!
...
!
!       for some reason the last movie frame has file problems
!       SO we process one less frame
!
        kframe = kframe -1
...
!      see if file is marked with an end of data flag...
             ...
             do ix=1,lndxt
              read(12+irnk-1,end=99) (Umovie(ix,kz),kz=lkztopf,lkzbtmf)
             enddo
