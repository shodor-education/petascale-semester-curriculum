...
//
//   tpebOmpimp makes the pebble images from the OpenMP lesson....
//   for MPI and OpenMP
//
...
//                      ../MPI-OpenMP-Pebble/scalar/data/pebble.hdr
//                      ../MPI-OpenMP-Pebble/openmp/openmp/data/pebble.hdr
//                      ../MPI-OpenMP-Pebble/openmpi/openmp/data/pebble.hdr
//                      ../MPI-OpenMP-Pebble/openmpimp/openmp/data/pebble.hdr
...
//fnameptr = fopen ("../MPI-OpenMP-Pebble/scalar/openmp/data/pebble.filenames","r");
  fnameptr = fopen ("../MPI-OpenMP-Pebble/openmpimp/data/pebble.filenames","r");

//fhdrptr  = fopen ("../MPI-OpenMP-Pebble/scalar/openmp/data/pebble.hdr","r");
  fhdrptr  = fopen ("../MPI-OpenMP-Pebble/openmpimp/data/pebble.hdr","r");
...
//sprintf(dirfilename,"../MPI-OpenMP-Pebble/scalar/openmp/data/pebble_mvlp00000.dat");
  sprintf(dirfilename,"../MPI-OpenMP-Pebble/openmpimp/data/pebble_mvlp00000.dat");
...
// add the directory to head of data file name
  for (int icm=0;icm<26;icm++)
    {
       dirfilename[icm+35] = filename[icm];
    }
