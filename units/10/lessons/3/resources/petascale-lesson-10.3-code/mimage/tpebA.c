...
//
//   tpebA makes the pebble images from the OpenACC lesson....
//
...
//                      ../Vis-Movie/data/pebble.mvlp
  ...
  fnameptr  =   fopen ("../OpenACC-Pebble/data/pebble.filenames","r");

  fhdrptr  =   fopen ("../OpenACC-Pebble/data/pebble.hdr","r");
...
// sprintf(dirfilename,"../MPI-Waves/data/pebble_mvlp00000.dat");
   sprintf(dirfilename,"../OpenACC-Pebble/data/pebble_mvlp00000.dat");
...
// add the directory to head of data file name
  for (int icm=0;icm<26;icm++)
    {
       dirfilename[icm+22] = filename[icm];
    }
