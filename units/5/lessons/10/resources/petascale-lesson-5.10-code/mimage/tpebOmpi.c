...
//
//   tpebOmpi makes the pebble images from the OpenMP lesson....
//   for MPI 
//
...
//fnameptr = fopen ("../MPI-OpenMP-Pebble/scalar/openmp/data/pebble.filenames","r");
  fnameptr = fopen ("../MPI-OpenMP-Pebble/openmpi/data/pebble.filenames","r");

//fhdrptr  = fopen ("../MPI-OpenMP-Pebble/scalar/openmp/data/pebble.hdr","r");
  fhdrptr  = fopen ("../MPI-OpenMP-Pebble/openmpi/data/pebble.hdr","r");
...
//sprintf(dirfilename,"../MPI-OpenMP-Pebble/scalar/openmp/data/pebble_mvlp00000.dat");
  sprintf(dirfilename,"../MPI-OpenMP-Pebble/openmpi/data/pebble_mvlp00000.dat");
...
// add the directory to head of data file name
  for (int icm=0;icm<26;icm++)
    {
       dirfilename[icm+33] = filename[icm];
    }
