...
//
//   tpebble makes the pebble images from the pebble lesson....
//
...
//sprintf(dirfilename, "../MPI-Waves/data/pebble_frame00000.dat");
//    
...
//                      ../Vis-Movie/data/pebble.mvlp
  ...
  fnameptr  =   fopen ("../Vis-Movie/data/pebble.filenames","r");

  fhdrptr  =   fopen ("../Vis-Movie/data/pebble.hdr","r");
