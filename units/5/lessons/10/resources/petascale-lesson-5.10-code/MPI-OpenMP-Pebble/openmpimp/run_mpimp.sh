...
# File: MPI-OpenMP-Pebble/openmpimp/run_mpimp.sh
...
mpif77 pebble_mpimp.f -o pebble_mpimp -O3 -fopenmp 


time mpirun -np  4  pebble_mpimp 



xmovie  <data/pebble.mvlp clip=0.05 n1=512 n2=512 height=1024 width=1024 loop=1 title=" BW Pond Wave Frame %g"
