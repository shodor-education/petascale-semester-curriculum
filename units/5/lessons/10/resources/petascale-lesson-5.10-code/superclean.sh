...
rm -f MPI-Waves/data/*
rm -f MPI-OpenMP-Pebble/scalar/data/*
rm -f MPI-OpenMP-Pebble/openmp/data/*
rm -f MPI-OpenMP-Pebble/openmpi/data/*
rm -f MPI-OpenMP-Pebble/openmpimp/data/*
rm -f OpenACC-Pebble/data/*
rm -f Vis-Movie/data/*

rm -f MPI-Waves/temp_fort/*
rm -f MPI-OpenMP-Pebble/openmpi/temp_fort/*
rm -f MPI-OpenMP-Pebble/openmpimp/temp_fort/*
